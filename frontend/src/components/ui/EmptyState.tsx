  ...
  return (
    <div className="card flex flex-col items-center justify-center gap-3 px-6 py-16 text-center">
      ...
      {cta && (
        <Link
          href={cta.href}
          className="mt-2 inline-flex h-10 items-center rounded-md bg-brand-crimson px-4 text-body-sm font-medium text-white transition-colors hover:bg-brand-crimson-hover"
        >
          {cta.label}
        </Link>
      )}
